...
def get_random_episode(tmdb_id, continual=False):
	...
	if continual:
		...
		set_property('B99_random_episode_history', json.dumps(episode_history))
...
def play_random_continual(tmdb_id):
	...
	url = get_property('B99_background_url')
	clear_property('B99_background_url')
