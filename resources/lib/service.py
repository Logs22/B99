...
class B99Monitor(xbmc_monitor):
	def __init__ (self):
		xbmc_monitor.__init__(self)
		logger('B99', 'Main Monitor Service Starting')
		logger('B99', 'Settings Monitor Service Starting')
	...
	def onScreensaverActivated(self):
		set_property('B99_pause_services', 'true')

	def onScreensaverDeactivated(self):
		clear_property('B99_pause_services')
	...
	def onNotification(self, sender, method, data):
		if method == 'System.OnSleep': set_property('B99_pause_services', 'true')
		elif method == 'System.OnWake': clear_property('B99_pause_services')


B99Monitor().waitForAbort()

logger('B99', 'Settings Monitor Service Finished')
logger('B99', 'Main Monitor Service Finished')