...
class YesNoProgressMedia(BaseDialog):
	...
	def make_items(self):
		...
		self.poster = self.meta.get(self.poster_main) or self.meta.get(self.poster_backup) or translate_path('special://home/addons/script.B99art/resources/media/box_office.png')
